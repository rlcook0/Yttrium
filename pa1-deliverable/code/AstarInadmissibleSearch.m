function [path,cost,nodesExpanded] = AstarInadmissibleSearch(World)
%Does A* search with an imadmissible heuristic.
%  path = AstarInadmissibleSearch(World).
...
while ~heapIsEmpty(heap)
    ...
    for successor_num = 1:size(successors)
        ...
        new_node.value = curr.sofar + dFrom + 100*dTo;
